function accuracy=nn_model(X_train,y_train,X_test,y_test)
dimensions=size(X_train, 2);
...
fprintf(['lambda value: %f '...
         '\n'], lambda);
fprintf('\nChoosing optimium lambda Neural Network... \n')
...
fprintf('\n model test run complete.....\n');
accuracy=nn_model_test(X_train,y_train,X_test,y_test,ideal_lambda)
